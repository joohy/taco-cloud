package com.action.in.taco.cloud.core.config;
...
@EnableJpaRepositories(
        basePackages = "com.action.in.taco.cloud.core.repository",
...
public class MariaDataSource {
    ...
    public LocalContainerEntityManagerFactoryBean testEntityManager() {
        ...
        //Entity 패키지 경로
        em.setPackagesToScan(new String[] { "com.action.in.taco.cloud.core.domain" });
